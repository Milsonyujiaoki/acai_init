...
export default function App() {
    ...
    return (_jsxs("div", { className: "min-h-screen bg-gray-50", children: [_jsx(Header, { cartItemsCount: cartItemsCount, onCartClick: () => setIsCartOpen(true), searchQuery: searchQuery, onSearchChange: setSearchQuery }), _jsx(CategoryNav, { categories: categories, activeCategory: activeCategory, onCategoryChange: setActiveCategory }), activeCategory === 'all' && !searchQuery && _jsx(FeaturedSection, {}), _jsxs("main", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8", children: [_jsxs("div", { className: "mb-6", children: [_jsx("h2", { className: "text-2xl mb-2", children: searchQuery
                                    ? `Search results for "${searchQuery}"`
                                    : activeCategory === 'all'
                                        ? 'All Products'
                                        : `${categories.find(c => c.id === activeCategory)?.name || ''}` }), _jsxs("p", { className: "text-gray-600", children: [filteredProducts.length, " products found"] })] }), _jsx(ProductGrid, { products: filteredProducts, cartItems: cartItems, onAddToCart: handleAddToCart, onRemoveFromCart: handleRemoveFromCart })] }), _jsx(CartSidebar, { isOpen: isCartOpen, onClose: () => setIsCartOpen(false), cartItems: cartItems, onUpdateQuantity: handleUpdateCartQuantity, onRemoveItem: handleRemoveCartItem })] }));
}
