...
import { Truck, TrendingUp, DollarSign, Calendar, ArrowUp, ArrowDown, Users, AlertTriangle, Clock, Target, MapPin, Fuel } from 'lucide-react';
...
export function ContextualKPICards() {
    ...
    return (_jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 xl:grid-cols-8 gap-4", children: kpiData.map((kpi, index) => (_jsx(Card, { className: "border-0 shadow-sm bg-white hover:shadow-md transition-all duration-200 cursor-pointer group", children: _jsxs(CardContent, { className: "p-4", children: [_jsxs("div", { className: "flex items-center justify-between mb-2", children: [_jsx("div", { className: `h-6 w-6 rounded-lg flex items-center justify-center ${colorClasses[kpi.color]} group-hover:scale-110 transition-transform`, children: _jsx(kpi.icon, { className: "h-3 w-3 text-white" }) }), _jsxs("div", { className: "flex items-center", children: [kpi.changeType === 'increase' ? (_jsx(ArrowUp, { className: "h-3 w-3 text-green-500" })) : (_jsx(ArrowDown, { className: "h-3 w-3 text-red-500" })), _jsx("span", { className: `text-xs ml-1 font-medium ${kpi.changeType === 'increase' ? 'text-green-600' : 'text-red-600'}`, children: kpi.change })] })] }), _jsxs("div", { className: "space-y-1", children: [_jsx("p", { className: "text-lg font-semibold text-gray-900 group-hover:text-blue-600 transition-colors", children: kpi.value }), _jsx("p", { className: "text-xs text-gray-600 font-medium", children: kpi.title }), _jsx("p", { className: "text-xs text-gray-400", children: kpi.subtitle }), _jsx("div", { className: "pt-1", children: _jsx("div", { className: `h-1 w-full rounded-full overflow-hidden ${kpi.changeType === 'increase' ? 'bg-green-100' : 'bg-red-100'}`, children: _jsx("div", { className: `h-full rounded-full transition-all duration-1000 ${kpi.changeType === 'increase' ? 'bg-green-500' : 'bg-red-500'}`, style: {
                                            width: kpi.changeType === 'increase' ? '75%' : '45%',
                                            animation: 'pulse 2s infinite'
                                        } }) }) })] })] }) }, index))) }));
}
//# sourceMappingURL=ContextualKPICards.js.map