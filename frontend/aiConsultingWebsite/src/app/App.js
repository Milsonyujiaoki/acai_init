    ...
    const navigate = useCallback((page, options) => {
        ...
        if (typeof window !== 'undefined' && window.gtag) {
            window.gtag('event', 'page_view', {
                page_title: seoConfig[targetPage]?.title || `${targetPage} | Delibix`,
...
export default function App() {
    ...
    const renderCurrentPage = () => {
        switch (currentPage) {
            ...
            case 'home':
                return (_jsxs(_Fragment, { children: [_jsx(ProblemSection, {}), _jsx(ProcessSection, {}), _jsx(ServicesSection, { navigate: navigate }), _jsx(CaseStudiesSection, { navigate: navigate }), _jsx(WhyDelibixSection, {}), _jsx(ToolsSection, { navigate: navigate }), _jsx(ContactSection, {})] }));
            // Core pages
            case 'about': return _jsx(AboutPage, { navigate: navigate });
            case 'contact': return _jsx(ContactPage, { navigate: navigate });
            case 'search': return _jsx(SearchPage, { navigate: navigate, searchQuery: searchQuery });
            case 'sitemap': return _jsx(SitemapPage, { navigate: navigate });
            case 'development-journey': return _jsx(DevelopmentJourneyPage, { navigate: navigate });
            case '404': return _jsx(NotFoundPage, { navigate: navigate });
            case '500': return _jsx(ServerErrorPage, { navigate: navigate });
            case 'maintenance': return _jsx(MaintenancePage, { navigate: navigate });
            // Business pages
            case 'pricing': return _jsx(PricingPage, { navigate: navigate });
            case 'services': return _jsx(ServicesPage, { navigate: navigate });
            case 'team': return _jsx(TeamPage, { navigate: navigate });
            case 'careers': return _jsx(CareersPage, { navigate: navigate });
            case 'branding': return _jsx(BrandingPage, { navigate: navigate });
            case 'investors': return _jsx(InvestorsPage, { navigate: navigate });
            case 'career-paths': return _jsx(CareerPathsPage, { navigate: navigate });
            case 'client-journey': return _jsx(ClientJourneyPage, { navigate: navigate });
            case 'client-testimonials': return _jsx(ClientTestimonialsPage, { navigate: navigate });
            case 'transformation-stories': return _jsx(TransformationStoriesPage, { navigate: navigate });
            case 'roi-showcase': return _jsx(ROIShowcasePage, { navigate: navigate });
            // Auth pages
            case 'login': return _jsx(LoginPage, { navigate: navigate });
            case 'signup': return _jsx(SignupPage, { navigate: navigate });
            case 'forgot-password': return _jsx(ForgotPasswordPage, { navigate: navigate });
            case 'account-dashboard': return _jsx(AccountDashboardPage, { navigate: navigate });
            case 'notifications': return _jsx(NotificationsPage, { navigate: navigate });
            // AI Tools pages
            case 'ai-playground': return _jsx(AIPlaygroundPage, { navigate: navigate });
            case 'ai-roi-calculator': return _jsx(AIROICalculatorPage, { navigate: navigate });
            case 'ai-readiness-checklist': return _jsx(AIReadinessChecklistPage, { navigate: navigate });
            case 'strategy-template': return _jsx(StrategyTemplatePage, { navigate: navigate });
            case 'agi': return _jsx(AGIPage, { navigate: navigate });
            case 'experiments': return _jsx(ExperimentsPage, { navigate: navigate });
            case 'cost-calculator': return _jsx(CostCalculatorPage, { navigate: navigate });
            case 'digital-readiness': return _jsx(DigitalReadinessPage, { navigate: navigate });
            case 'digital-transformation-planner': return _jsx(DigitalTransformationPlannerPage, { navigate: navigate });
            case 'compliance-checker': return _jsx(ComplianceCheckerPage, { navigate: navigate });
            case 'risk-assessment': return _jsx(RiskAssessmentPage, { navigate: navigate });
            case 'skill-assessment': return _jsx(SkillAssessmentPage, { navigate: navigate });
            case 'timeline-estimator': return _jsx(TimelineEstimatorPage, { navigate: navigate });
            case 'resource-planner': return _jsx(ResourcePlannerPage, { navigate: navigate });
            case 'competitor-analysis': return _jsx(CompetitorAnalysisPage, { navigate: navigate });
            case 'digital-benchmarks': return _jsx(DigitalBenchmarksPage, { navigate: navigate });
            // Industry pages
            case 'healthcare-digital': return _jsx(HealthcareDigitalPage, { navigate: navigate });
            case 'finance-digital': return _jsx(FinanceDigitalPage, { navigate: navigate });
            case 'manufacturing-digital': return _jsx(ManufacturingDigitalPage, { navigate: navigate });
            case 'retail-digital': return _jsx(RetailDigitalPage, { navigate: navigate });
            case 'education-digital': return _jsx(EducationDigitalPage, { navigate: navigate });
            case 'government-digital': return _jsx(GovernmentDigitalPage, { navigate: navigate });
            case 'sme-digital': return _jsx(SMEDigitalPage, { navigate: navigate });
            case 'startup-digital': return _jsx(StartupDigitalPage, { navigate: navigate });
            case 'agriculture-digital': return _jsx(AgricultureDigitalPage, { navigate: navigate });
            // Consulting pages
            case 'digital-strategy': return _jsx(DigitalStrategyPage, { navigate: navigate });
            case 'business-process': return _jsx(BusinessProcessPage, { navigate: navigate });
            case 'tech-stack-consulting': return _jsx(TechStackConsultingPage, { navigate: navigate });
            case 'data-strategy': return _jsx(DataStrategyPage, { navigate: navigate });
            case 'digital-workforce': return _jsx(DigitalWorkforcePage, { navigate: navigate });
            case 'cybersecurity-consulting': return _jsx(CyberSecurityConsultingPage, { navigate: navigate });
            case 'cloud-transformation': return _jsx(CloudTransformationPage, { navigate: navigate });
            case 'automation-consulting': return _jsx(AutomationConsultingPage, { navigate: navigate });
            case 'business-intelligence': return _jsx(BusinessIntelligencePage, { navigate: navigate });
            case 'ai-consulting-tools': return _jsx(AIConsultingToolsPage, { navigate: navigate });
            case 'consulting-frameworks': return _jsx(ConsultingFrameworksPage, { navigate: navigate });
            case 'consulting-methodology': return _jsx(ConsultingMethodologyPage, { navigate: navigate });
            case 'change-management': return _jsx(ChangeManagementPage, { navigate: navigate });
            case 'project-management': return _jsx(ProjectManagementPage, { navigate: navigate });
            case 'implementation-timeline': return _jsx(ImplementationTimelinePage, { navigate: navigate });
            case 'post-implementation': return _jsx(PostImplementationPage, { navigate: navigate });
            // Platform pages
            case 'digital-maturity': return _jsx(DigitalMaturityPage, { navigate: navigate });
            case 'business-transformation': return _jsx(BusinessTransformationPage, { navigate: navigate });
            case 'tech-stack-analyzer': return _jsx(TechStackAnalyzerPage, { navigate: navigate });
            case 'roi-dashboard': return _jsx(ROIDashboardPage, { navigate: navigate });
            case 'process-optimizer': return _jsx(ProcessOptimizerPage, { navigate: navigate });
            case 'api-exchange': return _jsx(APIExchangePage, { navigate: navigate });
            case 'digital-marketplace': return _jsx(DigitalMarketplacePage, { navigate: navigate });
            case 'integration-hub': return _jsx(IntegrationHubPage, { navigate: navigate });
            case 'innovation-lab': return _jsx(InnovationLabPage, { navigate: navigate });
            case 'tech-radar': return _jsx(TechRadarPage, { navigate: navigate });
            case 'vendor-ecosystem': return _jsx(VendorEcosystemPage, { navigate: navigate });
            // Technology pages
            case 'metaverse-consulting': return _jsx(MetaverseConsultingPage, { navigate: navigate });
            case 'iot-ecosystem': return _jsx(IoTEcosystemPage, { navigate: navigate });
            case 'edge-computing': return _jsx(EdgeComputingPage, { navigate: navigate });
            case 'quantum-computing': return _jsx(QuantumComputingPage, { navigate: navigate });
            case 'web3-integration': return _jsx(Web3IntegrationPage, { navigate: navigate });
            case 'ai-ethics-checker': return _jsx(AIEthicsCheckerPage, { navigate: navigate });
            case 'ai-research-center': return _jsx(AIResearchCenterPage, { navigate: navigate });
            case 'data-governance': return _jsx(DataGovernancePage, { navigate: navigate });
            // Academy pages
            case 'delibix-academy': return _jsx(DelibixAcademyPage, { navigate: navigate });
            case 'instructor-portal': return _jsx(InstructorPortalPage, { navigate: navigate });
            case 'exam-center': return _jsx(ExamCenterPage, { navigate: navigate });
            case 'client-onboarding': return _jsx(ClientOnboardingPage, { navigate: navigate });
            case 'enterprise-portal': return _jsx(EnterprisePortalPage, { navigate: navigate });
            // Regional pages
            case 'southeast-asia': return _jsx(SoutheastAsiaPage, { navigate: navigate });
            case 'indonesia-digital': return _jsx(IndonesiaDigitalPage, { navigate: navigate });
            case 'singapore-hub': return _jsx(SingaporeHubPage, { navigate: navigate });
            case 'malaysia-hub': return _jsx(MalaysiaHubPage, { navigate: navigate });
            case 'thailand-hub': return _jsx(ThailandHubPage, { navigate: navigate });
            case 'vietnam-hub': return _jsx(VietnamHubPage, { navigate: navigate });
            case 'asia-pacific': return _jsx(AsiaPacificPage, { navigate: navigate });
            case 'global-delivery': return _jsx(GlobalDeliveryPage, { navigate: navigate });
            // Resource pages
            case 'blog': return _jsx(BlogPage, { navigate: navigate });
            case 'community': return _jsx(CommunityPage, { navigate: navigate });
            case 'documentation': return _jsx(DocumentationPage, { navigate: navigate });
            case 'events-workshops': return _jsx(EventsWorkshopsPage, { navigate: navigate });
            case 'faq': return _jsx(FAQPage, { navigate: navigate });
            case 'help-center': return _jsx(HelpCenterPage, { navigate: navigate });
            case 'support': return _jsx(SupportPage, { navigate: navigate });
            case 'community-forum': return _jsx(CommunityForumPage, { navigate: navigate });
            case 'knowledge-base': return _jsx(KnowledgeBasePage, { navigate: navigate });
            case 'whitepapers': return _jsx(WhitepapersPage, { navigate: navigate });
            case 'glossary': return _jsx(GlossaryPage, { navigate: navigate });
            case 'best-practices': return _jsx(BestPracticesPage, { navigate: navigate });
            case 'template-library': return _jsx(TemplateLibraryPage, { navigate: navigate });
            case 'tools-directory': return _jsx(ToolsDirectoryPage, { navigate: navigate });
            case 'market-research': return _jsx(MarketResearchPage, { navigate: navigate });
            case 'future-of-digital': return _jsx(FutureOfDigitalPage, { navigate: navigate });
            case 'webinar-archive': return _jsx(WebinarArchivePage, { navigate: navigate });
            // Business development pages
            case 'newsletter': return _jsx(NewsletterPage, { navigate: navigate });
            case 'submit-idea': return _jsx(SubmitIdeaPage, { navigate: navigate });
            case 'affiliate': return _jsx(AffiliatePage, { navigate: navigate });
            case 'demo-request': return _jsx(DemoRequestPage, { navigate: navigate });
            case 'enterprise-solutions': return _jsx(EnterpriseSolutionsPage, { navigate: navigate });
            case 'success-stories': return _jsx(SuccessStoriesPage, { navigate: navigate });
            case 'developer-portal': return _jsx(DeveloperPortalPage, { navigate: navigate });
            case 'training-certification': return _jsx(TrainingCertificationPage, { navigate: navigate });
            case 'certification-program': return _jsx(CertificationProgramPage, { navigate: navigate });
            case 'course-catalog': return _jsx(CourseCatalogPage, { navigate: navigate });
            case 'digital-university': return _jsx(DigitalUniversityPage, { navigate: navigate });
            // Media pages
            case 'press-releases': return _jsx(PressReleasesPage, { navigate: navigate });
            case 'media-coverage': return _jsx(MediaCoveragePage, { navigate: navigate });
            case 'press-media-kit': return _jsx(PressMediaKitPage, { navigate: navigate });
            // Legal pages
            case 'privacy-policy': return _jsx(PrivacyPolicyPage, { navigate: navigate });
            case 'terms-service': return _jsx(TermsServicePage, { navigate: navigate });
            case 'security': return _jsx(SecurityPage, { navigate: navigate });
            case 'cookies-policy': return _jsx(CookiesPolicyPage, { navigate: navigate });
            case 'ethics-transparency': return _jsx(EthicsTransparencyPage, { navigate: navigate });
            // Admin pages
            case 'admin-dashboard': return _jsx(AdminDashboardPage, { navigate: navigate });
            case 'advanced-analytics': return _jsx(AdvancedAnalyticsDashboard, { navigate: navigate });
            case 'shopping-cart': return _jsx(ShoppingCartPage, { navigate: navigate });
            case 'merchandise-store': return _jsx(MerchandiseStorePage, { navigate: navigate });
            case 'system-status': return _jsx(SystemStatusPage, { navigate: navigate });
            case 'digital-research': return _jsx(DigitalResearchPage, { navigate: navigate });
            // Partners pages
            case 'clients': return _jsx(ClientsPage, { navigate: navigate });
            case 'partners': return _jsx(PartnersPage, { navigate: navigate });
            case 'channel-partners': return _jsx(ChannelPartnersPage, { navigate: navigate });
            case 'consulting-partners': return _jsx(ConsultingPartnersPage, { navigate: navigate });
            case 'implementation-partners': return _jsx(ImplementationPartnersPage, { navigate: navigate });
            case 'technology-partners': return _jsx(TechnologyPartnersPage, { navigate: navigate });
            case 'university-partners': return _jsx(UniversityPartnersPage, { navigate: navigate });
            default:
                return _jsx(NotFoundPage, { navigate: navigate });
        }
    };
    return (_jsx(ErrorBoundary, { children: _jsx(DarkModeProvider, { children: _jsx(LanguageProvider, { children: _jsxs(ToastProvider, { children: [_jsx(SEOHead, { ...currentSEO }), _jsx(LoadingScreen, { isVisible: isLoading, onComplete: handleLoadingComplete }), isAppReady && (_jsxs(motion.div, { className: "min-h-screen bg-background text-foreground", ref: scrollRef, initial: { opacity: 0 }, animate: { opacity: isLoading ? 0 : 1 }, transition: { duration: 0.5, ease: "easeOut" }, children: [!isOnline && (_jsx("div", { className: "fixed top-0 left-0 right-0 z-50 bg-yellow-500 text-white text-center py-2 text-sm font-medium", children: "You are currently offline. Some features may not be available." })), isInstallable && (_jsx("div", { className: "fixed top-0 left-0 right-0 z-40 bg-blue-600 text-white p-3", children: _jsxs("div", { className: "max-w-7xl mx-auto flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center", children: "\uD83D\uDCF1" }), _jsxs("div", { children: [_jsx("p", { className: "font-medium", children: "Install Delibix App" }), _jsx("p", { className: "text-xs opacity-90", children: "Get the best experience with our mobile app" })] })] }), _jsxs("div", { className: "flex items-center gap-2", children: [_jsx("button", { onClick: handleInstallPWA, className: "bg-white text-blue-600 px-4 py-2 rounded-lg text-sm font-medium hover:bg-blue-50 transition-colors", children: "Install" }), _jsx("button", { onClick: () => setIsInstallable(false), className: "text-white/80 hover:text-white transition-colors p-2", children: "\u2715" })] })] }) })), _jsx(Header, { navigate: navigate, currentPage: currentPage, onSearch: handleSearch }), _jsx("main", { className: "relative", style: { marginTop: !isOnline || isInstallable ? '60px' : '0' }, children: renderCurrentPage() }), _jsx(Footer, { navigate: navigate }), showLiveChat && (_jsx(LiveChatWidget, { position: "bottom-right", theme: "blue", showRating: true, showTypingIndicator: true, enableFileUpload: true, enableEmoji: true })), _jsx(ScrollToTopButton, { showLiveChat: showLiveChat, isNavigating: isNavigating, onScrollToTop: scrollToTop })] }))] }) }) }) }));
}
