...
import { Heart, Rocket, Code, Sparkles, Zap, Globe, Palette, Smartphone, Brain, Target, CheckCircle, Star, Award, Trophy, Users, Clock, ArrowRight, Download, Share2, BookOpen, Coffee, Lightbulb, Building, Shield, Search, Settings, Monitor, MousePointer, Layers, Eye, Navigation, Cpu, Database, Cloud, Lock, Wifi, BarChart3, Megaphone, MessageSquare, GitBranch, AlertTriangle, CheckSquare, TrendingUp, MapPin, Briefcase, DollarSign, BarChart, PieChart, LineChart, Calculator, FileText, Calendar, Target as TargetIcon, Compass, Flag, Play } from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";
export function DevelopmentJourneyPage({ navigate }) {
    ...
    const phases = t.phases || translations.en.phases;
    const stats = t.stats || translations.en.stats;
    const finalAchievements = t.finalAchievements || translations.en.finalAchievements;
    ...
    return (_jsxs("div", { className: `min-h-screen bg-background dark-mode-transition ${isRTL ? 'rtl' : 'ltr'}`, dir: isRTL ? 'rtl' : 'ltr', children: [_jsxs("section", { className: "relative min-h-screen flex items-center justify-center pt-32 pb-24 px-4 sm:px-6 lg:px-8 overflow-hidden", children: [_jsx("div", { className: "absolute inset-0 bg-gradient-to-br from-blue-50/50 via-white to-blue-100/30 dark:from-slate-900 dark:via-blue-950/40 dark:to-slate-800/30 transition-all duration-500" }), floatingParticles.slice(0, 10).map((i) => (_jsx(motion.div, { className: "absolute w-1 h-1 rounded-full bg-blue-400/20 dark:bg-blue-400/30 pointer-events-none", style: {
                            ...
                            delay: Math.random() * 2,
                            ease: "easeInOut"
                        } }, `particle-${i}`))), _jsx(AnimatePresence, { children: showCelebration && (_jsx("div", { className: "absolute inset-0 pointer-events-none", children: confettiParticles.slice(0, 20).map((i) => (_jsx(motion.div, { className: "absolute w-2 h-2 bg-gradient-to-r from-pink-500 to-purple-500 rounded-full", style: {
                                    left: `${Math.random() * 100}%`,
                                    top: `${Math.random() * 20}%`,
                                }, initial: { scale: 0, rotate: 0 }, animate: {
                                    scale: [0, 1, 0],
                                    rotate: [0, 180, 360],
                                    y: [0, -50, 100],
                                }, transition: {
                                    ...
                                    delay: Math.random() * 1,
                                    ease: "easeOut"
                                } }, `confetti-${i}`))) })) }), _jsx("div", { className: "relative z-20 max-w-7xl mx-auto text-center", children: _jsxs(motion.div, { initial: { opacity: 0, y: 40 }, animate: { opacity: 1, y: 0 }, transition: { duration: 1 }, className: "space-y-16", children: [_jsxs("div", { className: "space-y-8", children: [_jsxs(motion.div, { className: "flex items-center justify-center gap-6 flex-wrap", animate: { scale: [1, 1.05, 1] }, transition: { duration: 3, repeat: Infinity }, children: [_jsx(Heart, { className: "w-12 h-12 text-pink-500 fill-pink-500" }), _jsxs("div", { className: "space-y-4", children: [_jsx("h1", { className: "text-5xl sm:text-6xl lg:text-8xl font-bold text-slate-900 dark:text-white gradient-text-blue", children: t.pageTitle }), _jsx("p", { className: "text-xl sm:text-2xl lg:text-3xl text-slate-600 dark:text-slate-300 font-medium", children: t.pageSubtitle })] }), _jsx(Heart, { className: "w-12 h-12 text-pink-500 fill-pink-500" })] }), _jsx(motion.p, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.5, duration: 0.8 }, className: "text-lg sm:text-xl lg:text-2xl text-slate-700 dark:text-slate-300 max-w-4xl mx-auto leading-relaxed", children: t.heroDescription })] }), _jsx(motion.div, { initial: { opacity: 0, y: 30 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.8, duration: 0.8 }, className: "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6", children: stats.map((stat, index) => {
                                        const icons = [BookOpen, Globe, Code, Clock, Coffee, CheckCircle];
                                        const IconComponent = icons[index % icons.length];
                                        return (_jsxs(motion.div, { initial: { opacity: 0, scale: 0.8 }, animate: { opacity: 1, scale: 1 }, transition: { delay: 1 + index * 0.1, duration: 0.5 }, className: "glass p-6 rounded-2xl text-center hover-lift", children: [_jsx(IconComponent, { className: "w-8 h-8 mx-auto mb-3 text-blue-600 dark:text-blue-400" }), _jsx("div", { className: "text-2xl font-bold text-slate-900 dark:text-white mb-1", children: stat.value }), _jsx("div", { className: "text-sm text-slate-600 dark:text-slate-400", children: stat.label })] }, stat.label));
                                    }) })] }) })] }), _jsx("section", { className: "py-24 px-4 sm:px-6 lg:px-8", children: _jsxs("div", { className: "max-w-7xl mx-auto", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.8 }, className: "text-center mb-16", children: [_jsx("h2", { className: "text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-6", children: t.developmentStory }), _jsx("p", { className: "text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto", children: language === 'id' ? 'Perjalanan langkah demi langkah membangun platform digital yang luar biasa' :
                                                                        ...
                                                                        language === 'ur' ? 'ایک شاندار ڈیجیٹل پلیٹ فارم بنانے کا قدم بہ قدم سفر' :
                                                                            language === 'ko' ? '놀라운 디지털 플랫폼을 구축하는 단계별 여정' :
                                                                                language === 'ja' ? '素晴らしいデジタルプラットフォームを構築するステップバイステップの旅' :
                                                                                    'A step-by-step journey of building an amazing digital platform' })] }), _jsx("div", { className: "space-y-8", children: phases.map((phase, index) => {
                                const icons = [Lightbulb, Building, Palette, Globe, Smartphone, Zap, Navigation, Search, Trophy];
                                const IconComponent = icons[index % icons.length];
                                return (_jsxs(motion.div, { initial: { opacity: 0, x: index % 2 === 0 ? -50 : 50 }, whileInView: { opacity: 1, x: 0 }, transition: { duration: 0.8, delay: index * 0.1 }, className: `flex flex-col lg:flex-row items-center gap-8 ${index % 2 === 1 && !isRTL ? 'lg:flex-row-reverse' : ''} ${index % 2 === 0 && isRTL ? 'lg:flex-row-reverse' : ''}`, children: [_jsx("div", { className: "flex-shrink-0", children: _jsxs("div", { className: "relative", children: [_jsx("div", { className: "w-24 h-24 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center", children: _jsx(IconComponent, { className: "w-12 h-12 text-white" }) }), _jsx("div", { className: "absolute -top-2 -right-2 w-8 h-8 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center text-sm font-bold text-blue-600 border-2 border-blue-500", children: index + 1 })] }) }), _jsxs(Card, { className: "flex-1 glass-heavy p-8", children: [_jsxs(CardHeader, { className: "pb-4", children: [_jsxs("div", { className: "flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4", children: [_jsxs("div", { children: [_jsx(CardTitle, { className: "text-2xl font-bold text-slate-900 dark:text-white mb-2", children: phase.title }), _jsx("p", { className: "text-lg text-blue-600 dark:text-blue-400 font-medium", children: phase.subtitle })] }), _jsx(Badge, { variant: "secondary", className: "text-sm px-3 py-1", children: phase.date })] }), _jsx("p", { className: "text-slate-600 dark:text-slate-400 leading-relaxed", children: phase.description })] }), _jsxs(CardContent, { className: "space-y-6", children: [phase.achievements && (_jsxs("div", { children: [_jsxs("h4", { className: "font-semibold text-slate-900 dark:text-white mb-3 flex items-center gap-2", children: [_jsx(CheckCircle, { className: "w-5 h-5 text-green-500" }), t.achievements] }), _jsx("ul", { className: "space-y-2", children: phase.achievements.map((achievement, i) => (_jsxs("li", { className: "flex items-start gap-3 text-slate-600 dark:text-slate-400", children: [_jsx(Star, { className: "w-4 h-4 text-yellow-500 mt-1 flex-shrink-0" }), _jsx("span", { children: achievement })] }, i))) })] })), phase.techStack && (_jsxs("div", { children: [_jsxs("h4", { className: "font-semibold text-slate-900 dark:text-white mb-3 flex items-center gap-2", children: [_jsx(Code, { className: "w-5 h-5 text-blue-500" }), language === 'id' ? 'Teknologi' :
                                                                                                    ...
                                                                                                    language === 'jv' ? 'Teknologi' :
                                                                                                        language === 'ar' ? 'المكدس التقني' :
                                                                                                            language === 'ur' ? 'ٹیک اسٹیک' :
                                                                                                                language === 'ko' ? '기술 스택' :
                                                                                                                    language === 'ja' ? 'テックスタック' :
                                                                                                                        'Tech Stack'] }), _jsx("div", { className: "flex flex-wrap gap-2", children: phase.techStack.map((tech, i) => (_jsx(Badge, { variant: "outline", className: "bg-blue-50 dark:bg-blue-900/20 text-blue-700 dark:text-blue-300 border-blue-200 dark:border-blue-700", children: tech }, i))) })] })), phase.mood && (_jsx("div", { className: "pt-4 border-t border-slate-200 dark:border-slate-700", children: _jsx("p", { className: "text-center text-lg font-medium text-slate-700 dark:text-slate-300", children: phase.mood }) }))] })] })] }, phase.title));
                            }) })] }) }), _jsx("section", { className: "py-24 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-blue-50/50 to-purple-50/50 dark:from-slate-900/50 dark:to-blue-950/50", children: _jsxs("div", { className: "max-w-7xl mx-auto", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.8 }, className: "text-center mb-16", children: [_jsx(Trophy, { className: "w-16 h-16 mx-auto mb-6 text-yellow-500" }), _jsx("h2", { className: "text-4xl sm:text-5xl font-bold text-slate-900 dark:text-white mb-6", children: t.achievements }), _jsx("p", { className: "text-xl text-slate-600 dark:text-slate-400 max-w-3xl mx-auto", children: t.achievementsSummary || 'Amazing achievements from this collaborative development journey' })] }), finalAchievements && (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: finalAchievements.map((achievement, index) => (_jsx(motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.6, delay: index * 0.1 }, className: "glass p-6 rounded-2xl hover-lift", children: _jsx("p", { className: "text-lg text-slate-700 dark:text-slate-300 leading-relaxed", children: achievement }) }, index))) })), _jsx(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, transition: { duration: 0.8, delay: 0.5 }, className: "text-center mt-16", children: _jsxs("div", { className: "space-y-6", children: [_jsx("h3", { className: "text-2xl font-bold text-slate-900 dark:text-white", children: t.interestedCollaboration }), _jsx("p", { className: "text-lg text-slate-600 dark:text-slate-400 max-w-2xl mx-auto", children: t.joinNextJourney || 'Join us on the next digital innovation journey' }), _jsxs("div", { className: "flex flex-col sm:flex-row gap-4 justify-center", children: [_jsxs(Button, { onClick: () => navigate('contact'), size: "lg", className: "bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white px-8 py-3 rounded-xl", children: [_jsx(MessageSquare, { className: "w-5 h-5 mr-2" }), t.contactUs] }), _jsxs(Button, { onClick: () => navigate('services'), variant: "outline", size: "lg", className: "px-8 py-3 rounded-xl border-2 border-blue-600 text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-950", children: [_jsx(Rocket, { className: "w-5 h-5 mr-2" }), t.exploreServices] })] })] }) })] }) })] }));
}
//# sourceMappingURL=DevelopmentJourneyPage.js.map