...
import { Beaker, Brain, Cpu, Zap, Code, Database, Eye, Sparkles, Play, ChevronRight, ArrowRight, Star, Filter, Search, Lightbulb, Rocket, Settings, Monitor, Activity, TrendingUp, Bot, Microscope, Layers, Workflow, FileText, Globe, Target, Users, Clock, CheckCircle, AlertCircle, Info, BarChart3, PieChart, LineChart, Calendar, Bell, Lock, Heart, Bookmark, Share2, Download, ExternalLink, Github, MessageSquare, ThumbsUp, Gamepad2, Palette, Camera, Music, Video, Headphones, Smartphone, Tablet, Laptop, Timer, Gauge, Building, Truck, ShoppingCart, Plane, Car, Coffee, Home, Store, CreditCard, Banknote } from "lucide-react";
import { useDarkMode } from "./DarkModeProvider";
import { useLanguage } from "./LanguageProvider";
export function ExperimentsPage({ navigate }) {
    const { isDark } = useDarkMode();
    const { t, isRTL } = useLanguage();
    const { scrollY } = useScroll();
    const [selectedCategory, setSelectedCategory] = useState('all');
    const [searchQuery, setSearchQuery] = useState('');
    const [likedExperiments, setLikedExperiments] = useState(new Set());
    const [bookmarkedExperiments, setBookmarkedExperiments] = useState(new Set());
    ...
    const handleBookmark = (experimentId) => {
    ...
    return (_jsxs("div", { className: `min-h-screen bg-background ${isRTL ? 'rtl' : ''}`, children: [_jsxs("section", { className: "relative py-32 lg:py-40 overflow-hidden", children: [_jsxs("div", { className: "absolute inset-0 z-0", children: [_jsx(motion.div, { className: "absolute inset-0 bg-gradient-to-br from-background via-blue-50/60 to-blue-100/40 dark:from-slate-900 dark:via-blue-950/40 dark:to-slate-800/30", style: { y: heroY, opacity: heroOpacity } }), _jsx("div", { className: "absolute inset-0 opacity-10 dark:opacity-20", children: Array.from({ length: 20 }, (_, i) => (_jsx(motion.div, { className: "absolute w-2 h-2 bg-blue-500 rounded-full", style: {
                                        ...
                                        repeat: Infinity,
                                        delay: i * 0.2
                                    } }, i))) })] }), _jsx("div", { className: "relative z-10 max-w-7xl mx-auto px-6 text-center", children: _jsxs(motion.div, { initial: { opacity: 0, y: 30 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.8 }, className: "space-y-8", children: [_jsxs(motion.div, { className: `inline-flex items-center gap-3 glass-secondary rounded-full px-6 py-3 shadow-lg ${isRTL ? 'flex-row-reverse' : ''}`, initial: { opacity: 0, scale: 0.8 }, animate: { opacity: 1, scale: 1 }, transition: { duration: 0.6, delay: 0.2 }, children: [_jsx(Beaker, { className: "w-5 h-5 text-blue-600 dark:text-blue-400" }), _jsx("span", { className: `text-sm font-semibold ${isDark ? 'text-blue-300' : 'text-blue-600'}`, children: "AI Experiments Lab" }), _jsx(Sparkles, { className: "w-4 h-4 text-amber-500" })] }), _jsxs("div", { className: "space-y-6", children: [_jsxs(motion.h1, { className: `text-5xl md:text-7xl lg:text-8xl font-bold leading-tight ${isDark ? 'text-slate-100' : 'text-slate-900'}`, initial: { opacity: 0, y: 30 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.8, delay: 0.4 }, children: ["AI ", _jsx("span", { className: "gradient-text-blue", children: "Experiments" })] }), _jsx(motion.p, { className: `text-xl md:text-2xl max-w-4xl mx-auto leading-relaxed font-light ${isDark ? 'text-slate-400' : 'text-slate-500'}`, initial: { opacity: 0, y: 30 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.8, delay: 0.6 }, children: "Explore cutting-edge AI research, interactive tools, and experimental features. Discover the future of artificial intelligence through hands-on demos and open-source projects." })] }), _jsxs(motion.div, { className: "flex flex-col sm:flex-row gap-4 justify-center items-center pt-8", initial: { opacity: 0, y: 30 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.8, delay: 0.8 }, children: [_jsxs("div", { className: `glass-heavy rounded-2xl p-6 text-center ${isDark ? 'border-blue-400/20' : 'border-blue-200/50'}`, children: [_jsx("div", { className: `text-3xl font-bold mb-2 gradient-text-blue`, children: experiments.length }), _jsx("div", { className: `text-sm ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: "Active Experiments" })] }), _jsxs("div", { className: `glass-heavy rounded-2xl p-6 text-center ${isDark ? 'border-blue-400/20' : 'border-blue-200/50'}`, children: [_jsx("div", { className: `text-3xl font-bold mb-2 gradient-text-blue`, children: websiteRecreations.length }), _jsx("div", { className: `text-sm ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: "AI Website Recreations" })] }), _jsxs("div", { className: `glass-heavy rounded-2xl p-6 text-center ${isDark ? 'border-blue-400/20' : 'border-blue-200/50'}`, children: [_jsx("div", { className: `text-3xl font-bold mb-2 gradient-text-blue`, children: experiments.filter(exp => exp.category === 'open-source').length }), _jsx("div", { className: `text-sm ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: "Open Source" })] })] }), _jsxs(motion.div, { className: `flex flex-col sm:flex-row gap-4 justify-center items-center pt-8 ${isRTL ? 'sm:flex-row-reverse' : ''}`, initial: { opacity: 0, y: 30 }, animate: { opacity: 1, y: 0 }, transition: { duration: 0.8, delay: 1 }, children: [_jsx(Button, { size: "lg", className: "gradient-bg-blue text-white px-8 py-6 text-lg font-semibold rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300", onClick: () => {
                                                const element = document.getElementById('ai-recreations');
                                                if (element) {
                                                    element.scrollIntoView({ behavior: 'smooth' });
                                                }
                                            }, children: _jsxs("span", { className: `flex items-center gap-3 ${isRTL ? 'flex-row-reverse' : ''}`, children: ["View AI Recreations", _jsx(ArrowRight, { className: `w-5 h-5 ${isRTL ? 'rotate-180' : ''}` })] }) }), _jsx(Button, { variant: "outline", size: "lg", className: `px-8 py-6 text-lg font-semibold rounded-2xl backdrop-blur-xl ${isDark
                                            ...
                                            }, children: "Explore Experiments" })] })] }) })] }), _jsx("section", { id: "ai-recreations", className: "py-16 lg:py-24 bg-gradient-to-br from-blue-50/30 to-background dark:from-blue-950/10 dark:to-background", children: _jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.8 }, className: "text-center mb-16", children: [_jsxs("h2", { className: `text-4xl md:text-5xl font-bold mb-6 ${isDark ? 'text-slate-100' : 'text-slate-900'}`, children: ["AI Website ", _jsx("span", { className: "gradient-text-blue", children: "Recreation Lab" })] }), _jsx("p", { className: `text-lg max-w-4xl mx-auto leading-relaxed ${isDark ? 'text-slate-300' : 'text-slate-600'}`, children: "We experiment with recreating websites and platforms from 20 famous companies worldwide and in Indonesia. These AI-powered recreations are built in minutes to hours, demonstrating the speed and precision of our AI development capabilities." }), _jsxs("div", { className: "flex flex-wrap justify-center gap-8 mt-8", children: [_jsxs("div", { className: "text-center", children: [_jsx("div", { className: `text-3xl font-bold gradient-text-blue`, children: "45 mins" }), _jsx("div", { className: `text-sm ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: "Average Build Time" })] }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: `text-3xl font-bold gradient-text-blue`, children: "95%" }), _jsx("div", { className: `text-sm ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: "Design Accuracy" })] }), _jsxs("div", { className: "text-center", children: [_jsx("div", { className: `text-3xl font-bold gradient-text-blue`, children: "100%" }), _jsx("div", { className: `text-sm ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: "Responsive Design" })] })] })] }), _jsxs("div", { className: "mb-12 space-y-6", children: [_jsx("div", { className: "max-w-2xl mx-auto", children: _jsxs("div", { className: "relative", children: [_jsx(Search, { className: `absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 ${isDark ? 'text-slate-400' : 'text-slate-500'}` }), _jsx(Input, { type: "text", placeholder: "Search companies or platforms...", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: `pl-12 pr-4 py-6 text-lg rounded-2xl ${isDark
                                                    ? 'glass-heavy border-blue-400/20 bg-slate-800/30 text-slate-100 placeholder:text-slate-400'
                                                    : 'glass-heavy border-blue-200/50 bg-white/30 text-slate-900 placeholder:text-slate-500'} focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all duration-300` })] }) }), _jsx("div", { className: "flex flex-wrap justify-center gap-3", children: regionFilters.map((region) => (_jsxs(motion.button, { onClick: () => setSelectedRegion(region.id), className: `flex items-center gap-2 px-6 py-3 rounded-xl font-medium transition-all duration-200 ${selectedRegion === region.id
                                            ...
                                            : isDark
                                                ...
                                                : 'glass-secondary border border-blue-200/50 text-slate-600 hover:bg-blue-50'}`, whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, children: [_jsx(Globe, { className: "w-4 h-4" }), _jsx("span", { children: region.name }), _jsx("span", { className: `px-2 py-1 rounded-full text-xs ${selectedRegion === region.id
                                                    ...
                                                    : isDark
                                                        ...
                                                        : 'bg-blue-100 text-blue-600'}`, children: region.count })] }, region.id))) })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: filteredRecreations.map((recreation, index) => (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.4, delay: index * 0.05 }, className: `glass-heavy rounded-2xl overflow-hidden group hover:scale-105 transition-all duration-300 ${isDark ? 'border-blue-400/20' : 'border-blue-200/50'}`, children: [_jsxs("div", { className: `p-6 bg-gradient-to-r ${getCompanyColor(recreation.color)} text-white relative overflow-hidden`, children: [_jsx("div", { className: "absolute inset-0 bg-black/20" }), _jsxs("div", { className: "relative z-10 flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "w-12 h-12 rounded-xl bg-white/20 backdrop-blur-sm flex items-center justify-center", children: _jsx(recreation.icon, { className: "w-6 h-6 text-white" }) }), _jsxs("div", { children: [_jsx("h3", { className: "text-xl font-bold", children: recreation.company }), _jsx("p", { className: "text-white/80 text-sm", children: recreation.region === 'indonesia' ? 'Indonesia' : 'International' })] })] }), _jsx(Badge, { className: `border ${getStatusColor(recreation.status)}`, children: recreation.status })] })] }), _jsxs("div", { className: "p-6", children: [_jsx("h4", { className: `text-lg font-semibold mb-3 ${isDark ? 'text-slate-100' : 'text-slate-900'}`, children: recreation.title }), _jsx("p", { className: `text-sm mb-4 ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: recreation.description }), _jsxs("div", { className: "grid grid-cols-2 gap-4 mb-4", children: [_jsxs("div", { className: "text-center", children: [_jsxs("div", { className: "flex items-center justify-center gap-1 mb-1", children: [_jsx(Timer, { className: "w-4 h-4 text-green-500" }), _jsx("span", { className: `text-xs font-medium ${isDark ? 'text-slate-300' : 'text-slate-700'}`, children: "Build Time" })] }), _jsx("div", { className: "text-green-600 font-semibold text-sm", children: recreation.buildTime })] }), _jsxs("div", { className: "text-center", children: [_jsxs("div", { className: "flex items-center justify-center gap-1 mb-1", children: [_jsx(Gauge, { className: "w-4 h-4 text-orange-500" }), _jsx("span", { className: `text-xs font-medium ${isDark ? 'text-slate-300' : 'text-slate-700'}`, children: "Complexity" })] }), _jsx(Badge, { className: `text-xs border ${getComplexityColor(recreation.complexity)}`, children: recreation.complexity.replace('-', ' ') })] })] }), _jsx("div", { className: "mb-4", children: _jsxs("div", { className: "flex flex-wrap gap-1", children: [recreation.technologies.slice(0, 3).map((tech, techIndex) => (_jsx(Badge, { variant: "secondary", className: "text-xs", children: tech }, techIndex))), recreation.technologies.length > 3 && (_jsxs(Badge, { variant: "secondary", className: "text-xs", children: ["+", recreation.technologies.length - 3] }))] }) }), _jsxs("div", { className: "mb-4", children: [_jsx("h5", { className: `text-xs font-medium mb-2 ${isDark ? 'text-slate-300' : 'text-slate-700'}`, children: "Key Features:" }), _jsx("div", { className: "space-y-1", children: recreation.features.slice(0, 2).map((feature, featureIndex) => (_jsxs("div", { className: `flex items-center gap-2 text-xs ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: [_jsx(CheckCircle, { className: "w-3 h-3 text-green-500" }), feature] }, featureIndex))) })] }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-4 text-sm text-slate-500", children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Heart, { className: "w-3 h-3" }), _jsx("span", { className: "text-xs", children: recreation.likes })] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Eye, { className: "w-3 h-3" }), _jsx("span", { className: "text-xs", children: recreation.views })] })] }), _jsx("div", { className: "flex items-center gap-2", children: _jsxs(Button, { size: "sm", className: "rounded-lg h-8 px-3 text-xs bg-blue-600 hover:bg-blue-700 text-white", onClick: () => window.open(recreation.viewUrl, '_blank'), children: [_jsx(ExternalLink, { className: "w-3 h-3 mr-1" }), "View Demo"] }) })] })] })] }, recreation.id))) }), filteredRecreations.length === 0 && (_jsxs("div", { className: "text-center py-12", children: [_jsx(Search, { className: `w-16 h-16 mx-auto mb-4 opacity-50 ${isDark ? 'text-blue-400' : 'text-blue-500'}` }), _jsx("p", { className: `text-lg ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: "No recreations found matching your criteria." })] })), _jsx(motion.div, { className: "text-center mt-16", initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.8 }, children: _jsxs("div", { className: `glass-heavy rounded-2xl p-8 ${isDark ? 'border-blue-400/20' : 'border-blue-200/50'}`, children: [_jsx("h3", { className: `text-2xl font-bold mb-4 ${isDark ? 'text-slate-100' : 'text-slate-900'}`, children: "Want Your Website Recreated?" }), _jsx("p", { className: `text-lg mb-6 ${isDark ? 'text-slate-300' : 'text-slate-600'}`, children: "Experience the power of AI-driven web development. We can recreate any website with stunning accuracy in record time." }), _jsx(Button, { size: "lg", className: "gradient-bg-blue text-white px-8 py-4 text-lg font-semibold rounded-2xl", onClick: () => navigate && navigate('contact'), children: _jsxs("span", { className: `flex items-center gap-3 ${isRTL ? 'flex-row-reverse' : ''}`, children: ["Request Recreation", _jsx(ArrowRight, { className: `w-5 h-5 ${isRTL ? 'rotate-180' : ''}` })] }) })] }) })] }) }), _jsx("section", { id: "featured-experiments", className: "py-16 lg:py-24", children: _jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.8 }, className: "text-center mb-16", children: [_jsxs("h2", { className: `text-4xl md:text-5xl font-bold mb-6 ${isDark ? 'text-slate-100' : 'text-slate-900'}`, children: ["Featured ", _jsx("span", { className: "gradient-text-blue", children: "Experiments" })] }), _jsx("p", { className: `text-lg max-w-3xl mx-auto ${isDark ? 'text-slate-300' : 'text-slate-600'}`, children: "Discover our most popular and innovative AI experiments, from interactive tools to research breakthroughs." })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: featuredExperiments.slice(0, 6).map((experiment, index) => (_jsxs(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.6, delay: index * 0.1 }, className: `glass-heavy rounded-2xl overflow-hidden group hover:scale-105 transition-all duration-300 ${isDark ? 'border-blue-400/20' : 'border-blue-200/50'}`, children: [_jsxs("div", { className: "aspect-video bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 relative overflow-hidden", children: [_jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: _jsx(experiment.icon, { className: "w-16 h-16 text-blue-500 opacity-50" }) }), _jsxs("div", { className: "absolute top-4 left-4 flex gap-2", children: [_jsx(Badge, { className: `text-xs border ${getStatusColor(experiment.status)}`, children: experiment.status }), _jsx(Badge, { className: `text-xs border ${getDifficultyColor(experiment.difficulty)}`, children: experiment.difficulty })] }), experiment.interactive && (_jsx("div", { className: "absolute top-4 right-4", children: _jsx("div", { className: "w-8 h-8 rounded-full bg-green-500/20 border border-green-500/30 flex items-center justify-center", children: _jsx(Play, { className: "w-4 h-4 text-green-600" }) }) }))] }), _jsxs("div", { className: "p-6", children: [_jsx("div", { className: "flex items-start justify-between mb-3", children: _jsx("h3", { className: `text-xl font-semibold ${isDark ? 'text-slate-100' : 'text-slate-900'}`, children: experiment.title }) }), _jsx("p", { className: `text-sm mb-4 ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: experiment.description }), _jsx("div", { className: "flex flex-wrap gap-2 mb-4", children: experiment.tags.slice(0, 3).map((tag, tagIndex) => (_jsx(Badge, { variant: "secondary", className: "text-xs", children: tag }, tagIndex))) }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-4 text-sm text-slate-500", children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Heart, { className: `w-4 h-4 cursor-pointer transition-colors ${likedExperiments.has(experiment.id)
                                                                            ? 'text-red-500 fill-current'
                                                                            : 'text-slate-400 hover:text-red-500'}`, onClick: () => handleLike(experiment.id) }), _jsx("span", { children: experiment.likes })] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Bookmark, { className: `w-4 h-4 cursor-pointer transition-colors ${bookmarkedExperiments.has(experiment.id)
                                                                            ? 'text-blue-500 fill-current'
                                                                            : 'text-slate-400 hover:text-blue-500'}`, onClick: () => handleBookmark(experiment.id) }), _jsx("span", { children: experiment.bookmarks })] })] }), _jsxs("div", { className: "flex items-center gap-2", children: [experiment.demoUrl && (_jsx(Button, { size: "sm", variant: "outline", className: "rounded-lg", children: _jsx(Play, { className: "w-3 h-3" }) })), experiment.githubUrl && (_jsx(Button, { size: "sm", variant: "outline", className: "rounded-lg", children: _jsx(Github, { className: "w-3 h-3" }) }))] })] })] })] }, experiment.id))) })] }) }), _jsx("section", { id: "all-experiments", className: "py-16 lg:py-24 bg-gradient-to-br from-blue-50/30 to-background dark:from-blue-950/10 dark:to-background", children: _jsxs("div", { className: "max-w-7xl mx-auto px-6", children: [_jsxs(motion.div, { initial: { opacity: 0, y: 30 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.8 }, className: "text-center mb-16", children: [_jsxs("h2", { className: `text-4xl md:text-5xl font-bold mb-6 ${isDark ? 'text-slate-100' : 'text-slate-900'}`, children: ["All ", _jsx("span", { className: "gradient-text-blue", children: "Experiments" })] }), _jsx("p", { className: `text-lg max-w-3xl mx-auto ${isDark ? 'text-slate-300' : 'text-slate-600'}`, children: "Browse our complete collection of AI experiments, research projects, and innovative tools." })] }), _jsxs("div", { className: "mb-12 space-y-6", children: [_jsx("div", { className: "max-w-2xl mx-auto", children: _jsxs("div", { className: "relative", children: [_jsx(Search, { className: `absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 ${isDark ? 'text-slate-400' : 'text-slate-500'}` }), _jsx(Input, { type: "text", placeholder: "Search experiments...", value: searchQuery, onChange: (e) => setSearchQuery(e.target.value), className: `pl-12 pr-4 py-6 text-lg rounded-2xl ${isDark
                                                    ? 'glass-heavy border-blue-400/20 bg-slate-800/30 text-slate-100 placeholder:text-slate-400'
                                            ...
                                            : isDark
                                                ? 'glass-secondary border border-blue-400/20 text-slate-300 hover:bg-blue-400/10'
                                                : 'glass-secondary border border-blue-200/50 text-slate-600 hover:bg-blue-50'}`, whileHover: { scale: 1.02 }, whileTap: { scale: 0.98 }, children: [_jsx(category.icon, { className: "w-4 h-4" }), _jsx("span", { children: category.name }), _jsx("span", { className: `px-2 py-1 rounded-full text-xs ${selectedCategory === category.id
                                                    ? 'bg-white/20 text-white'
                                                    : isDark
                                                        ? 'bg-blue-500/20 text-blue-300'
                                                        : 'bg-blue-100 text-blue-600'}`, children: category.count })] }, category.id))) })] }), _jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8", children: filteredExperiments.map((experiment, index) => (_jsxs(motion.div, { initial: { opacity: 0, y: 20 }, whileInView: { opacity: 1, y: 0 }, viewport: { once: true }, transition: { duration: 0.4, delay: index * 0.05 }, className: `glass-heavy rounded-2xl overflow-hidden group hover:scale-105 transition-all duration-300 ${isDark ? 'border-blue-400/20' : 'border-blue-200/50'}`, children: [_jsxs("div", { className: "aspect-video bg-gradient-to-br from-blue-100 to-blue-200 dark:from-blue-900/30 dark:to-blue-800/30 relative overflow-hidden", children: [_jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: _jsx(experiment.icon, { className: "w-12 h-12 text-blue-500 opacity-50" }) }), _jsx("div", { className: "absolute top-3 left-3 flex gap-2", children: _jsx(Badge, { className: `text-xs border ${getStatusColor(experiment.status)}`, children: experiment.status }) }), experiment.interactive && (_jsx("div", { className: "absolute top-3 right-3", children: _jsx("div", { className: "w-6 h-6 rounded-full bg-green-500/20 border border-green-500/30 flex items-center justify-center", children: _jsx(Play, { className: "w-3 h-3 text-green-600" }) }) }))] }), _jsxs("div", { className: "p-6", children: [_jsx("h3", { className: `text-lg font-semibold mb-2 ${isDark ? 'text-slate-100' : 'text-slate-900'}`, children: experiment.title }), _jsx("p", { className: `text-sm mb-4 ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: experiment.description }), _jsx("div", { className: "flex flex-wrap gap-1 mb-4", children: experiment.tags.slice(0, 2).map((tag, tagIndex) => (_jsx(Badge, { variant: "secondary", className: "text-xs", children: tag }, tagIndex))) }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3 text-sm text-slate-500", children: [_jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Heart, { className: `w-3 h-3 cursor-pointer transition-colors ${likedExperiments.has(experiment.id)
                                                                            ? 'text-red-500 fill-current'
                                                                            : 'text-slate-400 hover:text-red-500'}`, onClick: () => handleLike(experiment.id) }), _jsx("span", { className: "text-xs", children: experiment.likes })] }), _jsxs("div", { className: "flex items-center gap-1", children: [_jsx(Bookmark, { className: `w-3 h-3 cursor-pointer transition-colors ${bookmarkedExperiments.has(experiment.id)
                                                                            ? 'text-blue-500 fill-current'
                                                                            : 'text-slate-400 hover:text-blue-500'}`, onClick: () => handleBookmark(experiment.id) }), _jsx("span", { className: "text-xs", children: experiment.bookmarks })] })] }), _jsxs("div", { className: "flex items-center gap-1", children: [experiment.demoUrl && (_jsx(Button, { size: "sm", variant: "outline", className: "rounded-lg h-8 w-8 p-0", children: _jsx(Play, { className: "w-3 h-3" }) })), experiment.githubUrl && (_jsx(Button, { size: "sm", variant: "outline", className: "rounded-lg h-8 w-8 p-0", children: _jsx(Github, { className: "w-3 h-3" }) }))] })] })] })] }, experiment.id))) }), filteredExperiments.length === 0 && (_jsxs("div", { className: "text-center py-12", children: [_jsx(Search, { className: `w-16 h-16 mx-auto mb-4 opacity-50 ${isDark ? 'text-blue-400' : 'text-blue-500'}` }), _jsx("p", { className: `text-lg ${isDark ? 'text-slate-400' : 'text-slate-600'}`, children: "No experiments found matching your criteria." })] }))] }) }), "Experiments"] }));
}
//# sourceMappingURL=ExperimentsPage.js.map