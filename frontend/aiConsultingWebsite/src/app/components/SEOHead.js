...
export function SEOHead({ title, description, keywords, canonicalUrl, ogImage = '/images/og/delibix-default.jpg', schemaType = 'WebPage', serviceName, serviceType, modifiedDate, breadcrumbs = [], noIndex = false, structuredData }) {
    useEffect(() => {
